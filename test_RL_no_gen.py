import os
import shutil
chkpt_root = "/home/willem/policies/v2_env_action_space_maybe_clipped"
...
config = (
    PPOConfig()
    .environment(env="selected_env", action_space=EnergyManagementEnv_no_gen_V2().action_space, clip_actions=True)
